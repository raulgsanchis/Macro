...
\end{document}
\section{Oppgaver med l?sningsforslag}
\begin{itemize}
\item Finn ved bruk av FRED Basispengemengden (M1) og M2 (M1) for USA  i ?rene f?r og etter finanskrisen og vis disse tallene grafisk.
...
Ta utgangspunkt i talleksemplet under system 3, anta videre at sentralbanken ved ? bruke av seddelpressen ?nsker ? kj?pe statsobligasjoner til 500 og et bilfirma til 600. Hvordan vil balansene se ut etter en slik endring?
\item Dersom forretningsbank 1 oppn?r et bratt fall i sine reserver, hvilke to muligheter gir system 3 for at banken skal kunne ?ke sin likviditet
\item Refinansieringsl?n:
Ta utgangspunkt i talleksemplet under system 3, anta videre at interbankmarkedet er ''frosset'' grunnet manglene tillit mellom forretningsbankene.  Hvordan vil balansen se ut dersom sentralbank l?n forretningsbanken et bel?p p? 75 \item Hva tror du vil skje med utl?nene til banksektoren dersom kapitalkravene for banksektoren ?ker?
\end{itemize}
\end{document}
