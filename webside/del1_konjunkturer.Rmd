...
# Huskeliste
1. Navn overskrift Mundell-Flemming
...
## IS-LM modellen for en lukket økonomi: likevekt i gode- og pengemarkedet 
## AD-AS modellen for en lukket økonomi: likevekt i gode-, penge- og arbeidsmarkedet 
## IS-LM og AD-AS modellen for en åpen økonomi (Mundell-Flemming) med fast valutakurs: 
## IS-LM og AD-AS modellen for en åpen økonomi (Mundell-Flemming) med flytende valutakurs: 
