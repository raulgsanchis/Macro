...
dfkurver = data.frame(kurve=c("45 grader ", "I", "I+G", "I+G+C"),
                      ...
                      x = c(50, dfkeynes$varnavnmaksverdi$Iv[c(3,5,6)]+10),
                      y = c(0, dfkeynes$varnavnmaksverdi$value[c(3,5,6)]+10))
...
#######################################h####################################################################
Iv <- 0:600
ekeynesexoparvalv <- c(list(c_1 = 0.6, oC = 50, oG= 50, b = 10, i = 2, oI = 50, T = 50), list(Y=c(Iv)))
