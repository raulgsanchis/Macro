...
eadaslikevekt <- adaslikevekt + eksadaslikevekt #+
...
Reduksjon i pengemengden ($\overline{M}<0$) fører til høyere rente og med til et negativt skift i AD-kurven på bakgrunn av de etterspørselsvirkningene som ble beskrevet under IS-LM modellen. Er reduksjonen riktig dosert, vil produksjon og arbeidslediget gå tilbake til sitt naturlige likevektsnivå, mens prisnivået (og med det inflasjonen) vil være uendret.
