...
# dfislm <- MakroOEKB1115::dfgpmakro(Iv=iv, exoparval = exoparvalv, endr=0)
# cdfislm <- MakroOEKB1115::dfgpmakro(Iv=iv, exoparval = cexoparvalv, endr=0)
# 
# # Pengemarkedet
...
#### Pengemarkedet (utvendige penger - M0)
...
Konstant pengemengdevekst $\frac{\Delta M}{M} = k$, hvor k er lik veksten i BNP eller inflasjonen, er forslaget fra Milton Friedman på en pengepolitisk regel som har hensikt å virke som en effektiv 
stabiliseringspolitisk virkemiddel. 

Forslaget kommer på bakgrunn av boken [*A Monetary History of the United States*](https://en.wikipedia.org/wiki/A_Monetary_History_of_the_United_States), som Friedman 
forfattet sammen med Anna J. Schwartz.I boken argumenteres det (basert på tidsserier for pengemengdeveksten i USA) at uforutsette endringer i pengemengden er hovedårsaken til konjunktursvingningene i USA i perioden 1867-1963

Innenfor IS-LM rammeverket, kan vi tolke dette som at sentralbanken har til oppgave ikke skape skift i LM-kurven som har sitt opphave i endringer i pengetilbudet.
