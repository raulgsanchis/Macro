...
Yv <- 225:300
exoparvalvadas <- c(list(c_1 = 0.6, oC = 25, oG= 75, b = 15, oI = 75, T = 10, M= 200, P=1, h = 80, k =2,Pe=2, mu = 0.1, l_1=-1,l_2=1, z=1, A=0.5, N=400, alpha = 1), list(Y=c(Yv)))
dfadas <- dfgpmakro3(Iv=Yv, exoparval=exoparvalvadas, modell='ad-asc', endr=0)
eqsoladas <- list(y= c(3.1), x= c(268))
...
#a <- figadas + geom_line(data=data.frame(x=250,y=0:10), x,y)
figadas
```
...
#Yv <- 225:300
#exoparvalv <- c(list(c_1 = 0.6, oC = 25, oG= 75, b = 15, oI = 75, T = 10, M= 200, P=1, h = 80, k =2,Pe=2, mu = 0.1, l_1=-1,l_2=1, z=1, A=0.5, N=400, alpha = 1), list(Y=c(Yv)))
#cexoparvalv <- c(list(c_1 = 0.6, oC = 25, oG= 75, b = 15, oI = 75, T = 10, M= 275, P=1, h = 80, k =2, Y = 300), list(i=c(iv)))
#dfadas <- dfgpmakro3(Iv=Yv, exoparval=exoparvalv, modell='ad-asc', endr=0)
#eqsoladas <- list(y= c(4.2), x= c(268))
...
cfigadas <- makrofigure(ndata = dfadas$dfmodell,
                       variables = c("adv", "asv"),
                       labt = adaslabels,
                       labplassmon = labldf,
                       equisol = eqsoladas,
