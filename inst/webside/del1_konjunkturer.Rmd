...
På mellomlang sikt (5-10 år) antar vi at $P=P^{e}$ (fagoreningen gjør ikke systematisk feil i sine prisforventninger). Det gjør at vi kan skrive:
$$1=(1+μ)1F(1 - \frac{Y^{n}}{AN},z)$$
Hvor $Y^{n}$ er det naturlige produksjonsnivået (produksjonsnivået som gjelder under fleksible priser og lønninger). 
...
$\mu=0 \text{ (perfekt konkurranse) } \Rightarrow \overline{Y}=Y^{n}$
...
Skjæringspunktet mellom AD- og AS-kurven gir oss produktprisen og likevek
