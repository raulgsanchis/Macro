...
Den samlede verdien av alle varer og tjenester som blir produsert i landet
...
#### Kort sikt (Keynes, IS-LM og Mundell-Fleming modellen, del I og III):
- Samlet etterspørsel ($AE$) bestemmer BNP ($Y$)

#### Mellomlang sikt (AD-AS modelen - del I):
- Tilgangen på innsatsfaktorene arbeidskraft ($L$), teknkologi ($A$) og kapital ($K$) bestemmer BNP ($Y$)

#### Lang sikt (Solow modellen - del II):
