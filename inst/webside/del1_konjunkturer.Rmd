...
### Endring
Yv <- 225:300
exoparvalv <- c(list(c_1 = 0.6, oC = 25, oG= 75, b = 15, oI = 75, T = 10, M= 200, P=1, h = 80, k =2,Pe=1, mu = 0.1, l_1=-1,l_2=1, z=1, A=1, N=1, alpha = 0.5), list(Y=c(Yv)))
#cexoparvalv <- c(list(c_1 = 0.6, oC = 25, oG= 75, b = 15, oI = 75, T = 10, M= 275, P=1, h = 80, k =2, Y = 300), list(i=c(iv)))

abc <- dfgpmakro3(Iv=Yv, exoparval=exoparvalv, modell='ad-asc', endr=0)

a <- qplot(data=subset(abc$dfmodell, variable == 'adv'), Iv, value, geom = 'line')
b <- qplot(data = subset(abc$dfmodell, variable == 'asv'), Iv, value, geom = 'line')
