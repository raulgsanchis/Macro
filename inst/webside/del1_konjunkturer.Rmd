...
## Numeriske verdier
iv <- 0:10
exoparvalv <- c(list(c_1 = 0.6, oC = 25, oG= 50, a = 30,oI = 50, T = 10, M= 590, P=1, h = 2, k =2, Y = 300), list(i=c(iv)))
...
figislm <- gpdiamdoell2(data = dfislm$dfmodell, variables = c("ldv", "msv"),
                           labt = lableg,
                           color = rep(c('black'),2))
...
## Labeling
lableg <- list(title= 'IS-LM diagrammet', x='Y', y='i')
