...
Krugman (1998), Brookings Papers on Economic Activity 
\item Krav om gjeldsreduksjon\\
Krugman og Eggertsson (2010), Quarterly Journal of Economics
\end{enumerate}
\end{frame}
\begin{frame}
\frametitle{(1) Demografiske endringer}
Generalbusjettlikningen for en lukket \o konomi 
\begin{equation*}
Y=C+\overline{I}+G
\end{equation*}
Konsumet
...
Demografiske endringer $\Delta \bar{C}<0$ gir f\o lgende endringer i BNP
\begin{equation*}
\Delta Y=\frac{1}{1-c\cdot (1-t)}\Delta\bar{C}<0
\end{equation*}
\end{frame}
\begin{frame}
Fors\o ke \aa motvirke dette ved \o kte etterspørsel gjennom en rentreduksjon
\begin{equation*}
\Delta Y=\frac{1}{1-c\cdot (1-t)}(\Delta\bar{C}-b\cdot \Delta i ^{0})<0
\end{equation*}
Vi har havnet i likvidietsfellen dersom 
\begin{equation*}
(\Delta\bar{C}-b\cdot \Delta i^{0})<0
\end{equation*}
Totaleffekten på \o konomien blir derfor negativ
\end{frame}
\begin{frame}
\frametitle{(2) Krav om privat gjeldsreduksjon}
Generalbusjettlikningen for en lukket \o konomi 
\begin{equation*}
Y=C+\overline{I}+G
\end{equation*}
...
\end{equation*}
Et krav om gjeldsreduksjon (Minsky-bevegelse) $\Delta D^{b} =(D^{lav}-D^{høy}<0)$ gir f \o lgende endringer i BNP 
\begin{equation*}
...
\end{frame}
\begin{frame}
\frametitle{Likviditetsfellen og statlig gjeldskrise}
Ved en ... som ikke blir n.
\begin{equation*}
\Delta T=t \Delta Y   
\end{equation*}
Demografi
...
\end{equation*}
Privat gjeldsreduksjon
\begin{equation*}
\Delta T=t \frac{1}{1-\overline{c}(1-t)}(\theta \Delta\bar{D}^{b}-b\cdot \Delta i ^{0})<0   
\end{equation*}
Den primære budsjettbalansen er gitt ved 
\begin{equation*}
\frac{G_{t}-T_{t}}{Y_{t}}
\end{equation*}
\end{frame}
\begin{frame}
\frametitle{Likviditetsfellen og finanspolitikk: En gratis lunsj?}
\begin{equation*}
