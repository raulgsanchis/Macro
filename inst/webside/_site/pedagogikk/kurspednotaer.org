...
1. Økonomiske kriser: Stabiliseringspolitikk (bail-out)
EKS: Hjelpepakker
...
*** Sentrale aktører
    - [X] Husholdninger
    - [X] Bedrifter
    - [ ] Finansinstitusjoner (investerings og forretningsbanker) 
    - [X] Sentralbanken
<<<<<<< HEAD
...
*** Motivasjon: Grunnleggende mekanisme hvordan faktisk produksjon avviker fra potensiell produksjon
    - [ ] Bilmetafor
*** Operasjonelle markeder
    - [X] Godemarkedet (varer og tjenester)
    - [ ] Pengemarkedet
    - [ ] Arbeidsmarkedet
    - [ ] Kredittmarkedet
    - [ ] Valutakursmarkedet

>>>>>>> 614b3f8971171a9b28f2025e0094ecae224a1b17
** IS-LM modellen for en lukket økonomi
*** Motivasjon: Modell som på kort sikt forklare hvordan faktisk produksjon avviker fra potensiell produksjon i en lukket økonomi  
*** Operasjonelle markeder:
    - [X] Godemarkedet (varer og tjenester)
    - [X] Pengemarkedet
    - [ ] Arbeidsmarkedet
...
*** Motivasjon: Modell som på mellomlang sikt forklarer de selvregulerende mekanismene i en lukket økonomi  
*** Operasjonelle markeder:
    - [X] Godemarkedet (varer og tjenester)
    - [X] Pengemarkedet
    - [X] Arbeidsmarkedet
...
*** Motivasjon: Modell som på kort sikt forklare hvordan faktisk produksjon avviker fra potensiell produksjon i en åpen økonomi under fast og flytende
...
=======
*** Motivasjon: Modell som på mellomlang sikt forklarer de selvregulerende mekanismene i en åpen økonomi under fast og flytende  
*** Mellomlang sikt
>>>>>>> 614b3f8971171a9b28f2025e0094ecae224a1b17
...
*** Sentrale aktører
    - [X] Husholdninger
    - [X] Bedrifter
    - [X] Finansinstitusjoner (investeringsbank) 
    - [ ] Sentralbanken
