...
ggsave(paste0(devtools::as.package(".")$path,'/inst/webside/figurer/islm/pengem.png'))
...
ggsave(paste0(devtools::as.package(".")$path,'/inst/webside/figurer/islm/islm.png'))
...
ggsave(paste0(devtools::as.package(".")$path,'/inst/webside/figurer/islm/pengemchm.png'))
...
ggsave(paste0(devtools::as.package(".")$path,'/inst/webside/figurer/islm/islmcm.png'))
