...
realvalutakursen $R_{3}=\frac{\overline{E}\cdot P^{*}}{P_{3}} \Rightarrow NX < 0 \Leftrightarrow IM > EX$. Noe som gjør nettogjelden ovenfor utlandet øker (jmf. utenriksregnskapet).

- Dersom offentlige myndigheter ikke gjør noe med denne situajonen ($\Delta G<0$ eller $\Delta T >0$), vil markedskreftene etterhvert løse situasjonen på egenhånd gjennom økt risikopremie ($\Delta rp> 0$).  
