...
### AD-AS modellen under fast valutakursregime
...
Men målet om ekstern balanse er ikke alltid oppfylt
...
intekstfig <- rfastadas$ggtyper[[5]]+coord_flip()
```
...
Vi antar her at målet om ekstern balanse automatisk blir sikret gjennom endringer i den nominelle valutakursen som følge av endringer i valutakursforventningene. Analysen blir her således av samme form (isomorfisk) som for en lukket økonomi.

Milton Friedman gir  "The Case for Flexible Exchange Rates" by Milton Friedman, published in Friedman's Essays in Positive Economics, University of Chicago Press, 1953.
