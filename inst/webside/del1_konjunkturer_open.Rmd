...
NX er definert som eksport $(EX)$ minus import $IM$ målt i enheter av det innenlandske godet:
...
Som forteller oss at den forventede avkastningen er lik mellom å investere i inn- og utland.
...
- Fast 
$$i =i^{*} + rp$$
Er fastkursregime troverdig $\Rightarrow rp = 0$
