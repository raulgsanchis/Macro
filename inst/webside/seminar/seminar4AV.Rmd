...
*$$Y = \frac{1}{1-c(1-t) + R(\cdot) m_{2}}  \left [ \overline{C} } - c_{1}\overline{T} + \overline{I} - b\cdot \overline{i} + \overline{G} + EX\Big( R(\cdot) \Big)  + R(\cdot)^{2}\cdot m_{1} \right] \text{: godemarkedet}$$*
