...
*Intern balanse: Produksjonsgapet er lukket $(Y-Y^{u})=0$*
...
*$$Y = \frac{1}{1-c(1-t) + R\cdot m_{2}}  \left [ \overline{C} + \overline{I} - b\cdot \overline{i} + \overline{G} + EX  + R^{2}\cdot m_{1} \right] \text{: godemarkedet}$$*
...
*$E=E(i,i^{u},E^{e}) \Rightarrow R = \frac{E(i,i^{u},E^{e})\cdot P^{u}}{P}=R(E(i,i^{u},E^{e}),P,P^{u}) = R(\cdot)$ Setter vi inn for $R(\cdot)$  godemarkedet får vi:*
...
realvalutakursen som gir en økningen i nettoeksporten (Marshall-Lerner betingelsen). Det er denne etterspørselsøkningen
