...
- Markedene: 
    ...
    + Pengemarkedet 
    + Arbeidsmarkedet
    + Finansinstitusjoner (investering og forretningbanker) 
    + Valutakursmarkedet.
...
- Mål på aggregert produksjon: BNP ($Y$) (Bruttonasjonalprodukt) $Y$
    + Sluttgoder
    + Merverdi
    + Inntekt
...
$U \equiv L - N$, hvor $N$ er antall personer i arbeid
...
- Hvordan bestemmes aggregert BNP?
    + Kort sikt
    + Mellomlang sikt
    + Lang sikt
...
$Z \equiv C + I + G + NX \\
NX \equiv X - R\cdot IM \\
CU + CA \equiv 0 \\$

### Mundell-Flemming modellen (IS-LM for en åpen øonomi)
- Fast kurs 
- Flytende kurs
### AD-AS
- Fast kurs 
