...
philipusag <- ggplot(data = fusadataI, aes(x = unem, y = inflation))  + geom_point() +  geom_smooth(method=lm, se=FALSE) + theme_classic() + labs(title = 'Philips-curven' ,x = 'Ledighetsrate', y = 'Inflation')
```
...
- Okuns lov (sammenheng mellom endring i ledighete og endring i BNP)
