...
Vi har at $\frac{\dot{k}}{k} =\frac{\dot{K}}{K}  - n$ [(lenke her til regneregler)](https://www.adasextended.com/formler.html), som gjør at vi, 
...
sdftekst <- data.frame(x=c(200 ,190, 200),y=c(15, 8.75, 6), kurve=c('f(k)', "(a+n+delta)k", 'sf(k)'), farge=c('red', 'red', 'red'))
...
dsdftekst <- data.frame(x=c(200 ,190, 200),y=c(15, 10.35, 6),kurve=c('f(k)', "(n'+a+delta)k", "sf(k)"), farge=c('red', 'red', 'red'))
