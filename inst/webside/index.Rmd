...
<p> Oppgaver til seminar 2 (5. februar) er lagt ut <p/>
<p> Forelesningsnotaer til uke 5 (Arbeidsmarkedet, ledighet og AS-kurven) er lagt ut </p>
</span>
...
```{r}
 source('~/gitclones/teaching/MakroOEKB1115/inst/webside/figurer/adas/adasl.R')
adaslikevekt
```
