...
ggsave(paste0(devtools::as.package(".")$path,'/inst/webside/figurer/sem1/okunshel.png'))
...
ggsave(paste0(devtools::as.package(".")$path,'/inst/webside/figurer/sem1/phillipshel.png'))
